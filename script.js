...
function getUserInput() {
    ...
    isCharTypeNum = confirm("Does it Include Numbers? ");
    isCharTypeUpper = confirm("Does it Include Upper Case? ");
    isCharTypeLower = confirm("Does it Include Lower Case? ");
    isCharTypeSpecial = confirm("Does it Include Special Characters? ");
};
